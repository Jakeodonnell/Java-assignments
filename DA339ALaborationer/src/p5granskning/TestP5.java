...
public class TestP5 {
    public static void testMethod1() throws Exception {
        Class cls1 = Class.forName("p5granskning.SimpleDice");
        Class cls2 = Class.forName("p5granskning.TestDice");
...
//        method.invoke(null, new Object[]{constr.newInstance(new Object[]{new Integer(4)}),new Integer(1000000)});
    ...
    public static void testMethod2() throws Exception {
        Class cls1 = Class.forName("p5granskning.OrdinaryPlayer");
        Class cls2 = Class.forName("p5granskning.Cheater");
        Class cls3 = Class.forName("p5granskning.TestDice");
        Class cls4 = Class.forName("p5granskning.SimpleDice");
        ...
        Method method = cls3.getDeclaredMethod("test", new Class[]{p5granskning.Player.class,int.class});
    ...
    public void programLoop() {
        ...
        while(choice!=0) {
            try {
                switch(choice) {
                    case 1 : runMain("p5granskning.TestSimpleDice"); break;
                    case 2 : runMain("p5granskning.TestOrdinaryPlayer"); break;
                    case 3 : testMethod1(); break;
                    case 4 : runMain("p5granskning.TestCheater"); break;
                    case 5 : testMethod2(); break;
                    case 6 : runMain("p5granskning.TestProbabilityDice"); break;
                }
            } catch (Exception e) {
