...
public class Program3g {
    public void calculate() {
        ...
        nbr1 = rand.nextInt(10) + 1;  // nbr1 = 1-10
        ...
        System.out.println("Heltalsdivision:          " + nbr1 + "/" + nbr2 + "=" +(double) nbr1 / nbr2);
        System.out.println("Rest vid heltalsdivision: " + nbr1 + "%" + nbr2 + "=" +(double) nbr1 % nbr2);        
    }
