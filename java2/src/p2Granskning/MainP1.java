...
//		ThreadedBufferedLoopServer server = new ThreadedBufferedLoopServer(5656); // added for p2 
//		IconManager iconManager = new IconManager(iconBuffer,server);//  added for p2  Modified manager with server		
		...
		ipManager.addIconProducer(new ArrayProducer(getIconArray(),50,2));
