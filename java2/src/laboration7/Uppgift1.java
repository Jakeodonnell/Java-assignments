	...
	private class UI extends JPanel implements ActionListener { 
		...
		public UI() {
			...
			try {
				...
				lblLocalIp.setText("IP="+localAddress.getHostAddress()+
						", Namn="+localAddress.getHostName());
			...
			setLayout(new GridLayout(3,1)); setPreferredSize(new Dimension(300,100)); add(lblLocalIp);
			add(pnlHostname);
			add(lblIp);
		...
		public void actionPerformed(ActionEvent e) { try {
			...
			lblIp.setText("Host ip: " + address.getHostAddress()); } catch (UnknownHostException e1) {
				e1.printStackTrace(); }
		} }
